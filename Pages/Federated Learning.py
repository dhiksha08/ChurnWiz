...
st.set_page_config(page_title="Trip Duration Predictor", layout="wide")
...
st.markdown(
        ...
        We have 3 clients. So a model is trained for each client and aggregated at the end . For XGBoost aggregation of hyperparameters is performed.
        **Global Model Accuracy using Federated Learning :** 98.56%""")
